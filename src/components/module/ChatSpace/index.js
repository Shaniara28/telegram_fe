        ...
        <div className={style.chatspace}>
          <div className={style.headchat}>
            ...
            <div>
              ...
              {onlineUser?.includes(receiver_id) ? (
                <span>Online</span>
              ) : (
                <span
                  style={{
            ...
            <img src={logout} alt="" id="menu" onClick={handleLogout} className={style.logout} />
          </div>
          <div className={style.bodychat}>
            {messages
              ? messages.map((data) => {
                  return (
                    <div id="message" key={data.id} className={data.receiver_id !== receiver_id ? style.left : style.right}>
                      {data.body}
                      <div
                        id={data.id}
                        onClick={(e) => {
